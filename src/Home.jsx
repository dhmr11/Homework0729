...
const Home = () => {
  ...
  const Mytown = weatherData.slice(0,1)
        ...
        <DataTable>
          ...
          <tbody>
            {weatherData.map((lion,idx)=>(
              <tr key={idx}>
                <td style={{color:`${lion.MSRSTE_NM}` === "강서구" ?  "orange" : "" }}>{lion.MSRRGN_NM}</td>
                <td style={{color:`${lion.MSRSTE_NM}` === "강서구" ?  "orange" : "" }} onClick={() => navigate(`/detail/${lion.MSRSTE_NM}`,{state: {region: lion.MSRRGN_NM , place: lion.MSRSTE_NM , date: lion.MSRDT , dust:lion.PM10, superdust:lion.PM25 , o3:lion.O3,gas:lion.ARPLT_MAIN, envpoint:lion.IDEX_MVL }})}>{lion.MSRSTE_NM}</td>
                <td style={{color:`${lion.MSRSTE_NM}` === "강서구" ?  "orange" : "" }}>{lion.PM10}</td>
                <td style={{color:`${lion.MSRSTE_NM}` === "강서구" ?  "orange" : "" }}>{lion.PM25}</td>
                ...
                <td style={{color:`${lion.MSRSTE_NM}` === "강서구" ?  "orange" : "" }}>{lion.IDEX_MVL}</td>                
              </tr>
            ))}
          </tbody>
